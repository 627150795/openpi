...
- [`ADVISOR_REVIEWER_BENCHMARK_PROTOCOL.md`](ADVISOR_REVIEWER_BENCHMARK_PROTOCOL.md) — reproducible four-arm protocol for continuous Advisor versus on-demand review
