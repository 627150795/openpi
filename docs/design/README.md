...
- [`PERSISTENT_EVAL_BENCHMARK_PROTOCOL.md`](PERSISTENT_EVAL_BENCHMARK_PROTOCOL.md) — paired protocol for one-shot tools, persistent compute, and restricted Tool Bridge
