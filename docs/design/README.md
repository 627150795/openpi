...
- [`CONTEXT_COMPACTION_COMPARISON.md`](CONTEXT_COMPACTION_COMPARISON.md) — fixed-version comparison of compaction, pruning, persistence, caching, and recovery boundaries