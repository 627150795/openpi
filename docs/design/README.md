...
- [`COMPLETION_INBOX_CONTRACT.md`](COMPLETION_INBOX_CONTRACT.md) — producer ownership, destination epochs, per-result receipts, wake policy, and at-least-once delivery boundaries