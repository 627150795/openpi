...
- [`MODEL_VISIBLE_CONTEXT_CONTRACT.md`](MODEL_VISIBLE_CONTEXT_CONTRACT.md) — model-visible sources, injection order, provenance, authority, refresh, and provider-boundary evidence
