...
- [`TOOL_SCHEMA_ROLE_DISCLOSURE_CONTRACT.md`](TOOL_SCHEMA_ROLE_DISCLOSURE_CONTRACT.md) — bounded role disclosure, child execution boundaries, schema stability, and cache evidence