...
- [`STRUCTURED_SUBAGENT_RESULT_CONTRACT.md`](STRUCTURED_SUBAGENT_RESULT_CONTRACT.md) — design boundary for canonical child results, parent projections, validation, and partial outcomes
