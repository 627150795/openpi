...
- [`PI_AGENTHARNESS_COMPATIBILITY_BASELINE.md`](PI_AGENTHARNESS_COMPATIBILITY_BASELINE.md) — Phase 0 version matrix and reproducible smoke-test contract for Pi compatibility tracking
