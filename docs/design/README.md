...
- [`ON_DEMAND_LSP_CAPABILITY_CONTRACT.md`](ON_DEMAND_LSP_CAPABILITY_CONTRACT.md) — design boundary for explicit LSP loading, ownership, read/write scope, and fail-closed lifecycle
