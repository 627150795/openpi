...
- [`RECOVERABLE_RESOURCE_REFERENCE_CONTRACT.md`](RECOVERABLE_RESOURCE_REFERENCE_CONTRACT.md) — owner-scoped resource identity, artifacts, projections, retention, and recovery boundaries