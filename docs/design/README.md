...
- [`EXPLORATION_CHECKPOINT_REWIND_CONTRACT.md`](EXPLORATION_CHECKPOINT_REWIND_CONTRACT.md) — exploration checkpoint, rewind, branch, recovery, and `context_pivot` boundaries