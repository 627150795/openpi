...
- [`PACKAGE_WIDE_ADMISSION_LEASE_CONTRACT.md`](PACKAGE_WIDE_ADMISSION_LEASE_CONTRACT.md) — shared resource admission without merging Subagent, Workflow, and Terminal lifecycles
