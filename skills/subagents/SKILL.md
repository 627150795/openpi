...
- For the built-in explorer, `high` fits routine local tracing, `xhigh` fits interacting lifecycle/concurrency/trust boundaries, and `max` is only for exceptionally broad unresolved architecture.
